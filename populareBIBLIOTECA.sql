...
BEGIN
  ...
  -------------------
   ...
   FOR v_i IN 1..2000 LOOP
    ...
    insert into imprumuturi values(v_i,TRUNC(DBMS_RANDOM.VALUE(0,v_nrCarti)+1), TRUNC(DBMS_RANDOM.VALUE(0,10000)+1), v_data_tranzactie, v_data_limita, sysdate, sysdate);
   END LOOP;
   ...
   FOR v_i IN 1..500 LOOP
    ...
    insert into tranzactii values(v_i,(DBMS_RANDOM.VALUE(0,v_nrCarti)+1),(DBMS_RANDOM.VALUE(0,10000)+1),v_tip, sysdate, sysdate);
   END LOOP;
