   ...
   END IF;
     ...
     --1470
      ...
      v_an_publicatie := TO_DATE('01-01-1960','MM-DD-YYYY')+TRUNC(DBMS_RANDOM.VALUE(0,365))+TRUNC(DBMS_RANDOM.VALUE(0,40))*365;
          v_pret:=DBMS_RANDOM.VALUE(10,500);  
    insert into carti values(v_i2,(DBMS_RANDOM.VALUE(1,5000)), v_titlu_carte,  v_an_publicatie, v_gen_carte,v_nr_disponibile,v_nr_totale,v_pret, sysdate, sysdate);
   END LOOP;
